...
import { CreateVehicleDto, UpdateVehicleDto, VehicleFilterParams } from '@/types/vehicle.types';
...
export const useUpdateVehicle = () => {
  ...
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: UpdateVehicleDto }) => updateVehicle(id, data),
