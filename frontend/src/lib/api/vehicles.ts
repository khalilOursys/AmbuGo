// src/api/vehicles.ts
import { Vehicle, VehicleFilterParams, PaginatedResponse, VehicleStaffSchedule, CreateVehicleDto } from '@/types/vehicle.types';
 ...
 */
export const updateVehicle = async (id: string, data: FormData): Promise<Vehicle> => {
