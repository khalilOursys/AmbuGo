// app/vehicles/[companyId]/page.tsx
"use client";
...
export default function VehiclesPage() {
    ...
    const { data, isLoading, isError } = useQuery({
        queryKey: ["vehicles", companyId, page, limit, filters],
        queryFn: () =>
            fetchVehicles({
                page,
                limit,
    ...
    const handleAdd = () => {
        router.push(`/vehicles/${companyId}/add`);
    };

    const handleEdit = (vehicle: Vehicle) => {
        router.push(`/vehicles/${companyId}/edit/${vehicle.id}`);
    };

    const handleView = (vehicle: Vehicle) => {
        router.push(`/vehicles/${companyId}/${vehicle.id}`);
    };
