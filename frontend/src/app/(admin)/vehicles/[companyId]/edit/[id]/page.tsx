...
export default function EditVehiclePage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    const vehicleData = {
      ...
      staffSchedules: formData.staffSchedules.filter(s => s.staffId),
      equipment: formData.equipment.filter(e => e.equipmentId),
    };
    ...
    try {
      await updateVehicle.mutateAsync({ id: vehicleId, data: submitData });
