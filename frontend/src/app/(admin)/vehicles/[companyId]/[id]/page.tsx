// src/app/vehicles/[companyId]/[id]/page.tsx
"use client";
...
import { Pencil, ArrowLeft, Users, Package, MapPin, Clock } from "lucide-react";
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={() => router.push(`/vehicles/${companyId}/edit/${vehicle.id}`)}
