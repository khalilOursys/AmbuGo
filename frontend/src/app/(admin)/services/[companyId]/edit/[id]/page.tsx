...
const updateService = async ({ id, data }: { id: string; data: UpdateServiceDto }) => {
  // Convert unitPrice to float if it exists and is a string
  const formattedData = { ...data };
  if (formattedData.unitPrice !== undefined && formattedData.unitPrice !== null) {
    formattedData.unitPrice = parseFloat(formattedData.unitPrice as any);
    if (isNaN(formattedData.unitPrice)) {
...
export default function EditServicePage() {
  ...
  const submitForm = async (event: React.FormEvent) => {
    ...
    updateMutation.mutate({ id: serviceId, data: formData });
  };
